  ...
  export function AboutHero() {
    return (
      <section className="relative overflow-hidden text-white">
        ...
        <div className="container-px relative py-[64px]">
          <Reveal>
            <div className="max-w-[560px] rounded-[20px] border border-white/[0.18] bg-white/10 p-[40px_38px] backdrop-blur-[14px]">
              <span className="mb-3.5 inline-block text-[.74rem] font-bold uppercase tracking-[0.16em] text-brand-300">
                Precision Engineering
              </span>
              <h1 className="text-[clamp(2rem,4.6vw,3rem)] font-extrabold leading-[1.1] text-white">
                Building Stronger Water Systems for Every Project
              </h1>
              <p className="my-[18px] mb-[26px] text-[1.02rem] text-slate-200/85">
              ...
              <Button asChild><Link to="/products">Browse Categories <ArrowRight /></Link></Button>
              <div className="mt-[34px] flex flex-wrap gap-4">
                {STATS.map((s) => (
                  <div key={s.label} className="flex items-center gap-3 rounded-[14px] border border-white/[0.16] bg-white/10 p-[16px_22px] backdrop-blur-[10px]">
